# SRPCOM HERMES PORTABLE — Command Reference

## Portable Launcher Commands

These are the commands you type in your terminal / PowerShell.

### Windows (`SRPCOMHERMES.bat`)

| Command | What it does |
|---------|-------------|
| `SRPCOMHERMES.bat` | Start Hermes TUI (chat interface) |
| `SRPCOMHERMES.bat hermes` | Same as above |
| `SRPCOMHERMES.bat setup` | Run setup wizard |
| `SRPCOMHERMES.bat hermes setup` | Same as above |
| `SRPCOMHERMES.bat gateway` | Start messaging gateway (Telegram, etc.) |
| `SRPCOMHERMES.bat hermes gateway` | Same as above |
| `SRPCOMHERMES.bat hermes gateway restart` | Restart gateway |
| `SRPCOMHERMES.bat hermes gateway stop` | Stop gateway |
| `SRPCOMHERMES.bat hermes doctor` | Check for issues |
| `SRPCOMHERMES.bat hermes status` | Show current status |
| `SRPCOMHERMES.bat hermes config` | View current config |
| `SRPCOMHERMES.bat hermes config edit` | Edit config in default editor |
| `SRPCOMHERMES.bat hermes chat` | Start chat mode |
| `SRPCOMHERMES.bat hermes update` | Update Hermes to latest version |
...
These work inside `SRPCOMHERMES.bat` / `launch.sh` after `hermes`.
