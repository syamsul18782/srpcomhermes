...
REM ============================================================================
REM SRPCOM HERMES PORTABLE - Portable Launcher (Windows)
REM ============================================================================
...
if not exist "%RUNTIME_DIR%\ready.flag" (
    echo.
    echo ============================================
    echo   SRPCOM HERMES PORTABLE - First Run Setup
    echo ============================================
...
if not exist "%SRC_DIR%\hermes-agent" (
    echo [ERROR] SRPCOM HERMES PORTABLE source not found. Please delete .cache and try again.
    pause
    exit /b 1
)
...
echo %BOLD%%BRIGHT_WHITE%                     SRPCOM HERMES PORTABLE%RESET%
...
echo %BRIGHT_CYAN%----------------------------------------------------------------%RESET%
echo.
echo  %BRIGHT_YELLOW%[1]%RESET%  %WHITE%Start SRPCOM HERMES Chat%RESET%
echo  %BRIGHT_YELLOW%[2]%RESET%  %WHITE%Setup / Reconfigure SRPCOM HERMES%RESET%
echo  %BRIGHT_YELLOW%[3]%RESET%  %WHITE%Change AI Model%RESET%
...
if errorlevel 3 goto :menu_model
...
:menu_model
echo.
python -c "from hermes_cli.main import main; main()" setup model
goto :detect_status
...
echo  %BRIGHT_YELLOW%[5]%RESET%  %WHITE%Update SRPCOM HERMES%RESET%         %GRAY%- fetch latest%RESET%
