#!/bin/bash
# ============================================================================
# SRPCOM HERMES PORTABLE - Portable Launcher (macOS / Linux)
# ============================================================================
# Terminal:   ./launch.sh
...
show_menu() {
    ...
    echo -e "${BOLD}${BRIGHT_WHITE}                     SRPCOM HERMES PORTABLE${RESET}"
    ...
    echo -e "${BRIGHT_CYAN}----------------------------------------------------------------${RESET}"
    echo ""
    echo -e "  ${BRIGHT_YELLOW}[1]${RESET}  ${WHITE}Start SRPCOM HERMES Chat${RESET}"
    echo -e "  ${BRIGHT_YELLOW}[2]${RESET}  ${WHITE}Setup / Reconfigure SRPCOM HERMES${RESET}"
    echo -e "  ${BRIGHT_YELLOW}[3]${RESET}  ${WHITE}Change AI Model${RESET}"
...
show_advanced() {
    ...
    echo -e "  ${BRIGHT_YELLOW}[5]${RESET}  ${WHITE}Update SRPCOM HERMES${RESET}         ${GRAY}- fetch latest${RESET}"
